...
key_mapper('n', '<leader>q', ':lua require"telescope.builtin".quickfix()<CR>')
key_mapper('n', '<leader>qh', ':lua require"telescope.builtin".quickfixhistory()<CR>')
key_mapper('n', '<leader>j', ':lua require"telescope.builtin".jumplist()<CR>')
key_mapper('n', '<leader>r', ':lua require"telescope.builtin".registers()<CR>')
key_mapper('n', '<leader>ff', ':lua require"telescope.builtin".current_buffer_fuzzy_find()<CR>')
key_mapper('n', '<leader>tt', ':lua require"telescope.builtin".treesitter()<CR>')
key_mapper('n', '<leader>tfs', ':lua require"telescope.builtin".grep_string()<CR>')
key_mapper('n', '<leader>kb', ':lua require"telescope.builtin".keymaps()<CR>')
